    ...
    return (
        <>
            <header className="relative bg-mobile lg:bg-transparent">
                <div className="grid grid-cols-nav-center justify-items-center border-b-[1px] border-b-white/[0.104] px-6 py-8 md:mx-10 md:grid-cols-center-element-left md:px-0 lg:mx-[80px] lg:grid-cols-nav-center lg:justify-items-center lg:px-0 lg:py-[35px] 1xl:mx-[165px]">
