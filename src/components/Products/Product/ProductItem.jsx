...
export function ProductItem({ thumbnail, title, description, newProduct }) {
    return (
        <section className="containerProduct lg:flex lg:items-center lg:justify-between lg:gap-[6.875rem] ">
            ...
            <div className="space-y-6 pt-8 text-center md:space-y-0 md:pt-[3.25rem] lg:w-[43%] lg:pt-0 lg:text-left">
